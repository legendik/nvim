      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          wk.add {
            ...
            { '<leader>ca', vim.lsp.buf.code_action, desc = '[C]ode [A]ctions', mode = { 'n', 'x' } },
          }
          ...
          wk.add {
            ...
            { '<leader>gO', builtin.lsp_document_symbols, desc = 'Open Document Symbols' },
            { '<leader>gW', builtin.lsp_dynamic_workspace_symbols, desc = 'Open Workspace Symbols' },
            { '<leader>gt', builtin.lsp_type_definitions, desc = '[G]oto [T]ype Definition' },
          }
          ...
          if client and client_supports_method(client, vim.lsp.protocol.Methods.textDocument_inlayHint, event.buf) then
            wk.add {
              { 't', group = '[T]oggle' },
              { 'th', vim.lsp.inlay_hint.enable(not vim.lsp.inlay_hint.is_enabled { bufnr = event.buf }), desc = '[T]oggle [H]ints' },
            }
          end
        end,
      })
